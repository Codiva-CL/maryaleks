...
export const metadata: Metadata = {
  title: 'Marina Alekseeva — Front-end Developer',
  description: 'Front-end Developer with 4+ years of experience in the JavaScript ecosystem. Based in Santiago, Chile.',
};
